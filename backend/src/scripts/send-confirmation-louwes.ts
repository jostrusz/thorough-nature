 ...
 * NL2026-32891 (Myra Louwes, see create-order-louwes-banktransfer.ts).
 *
 ...
 * 2026-37197 already exists and is now marked paid.
 *
 * E-books are delivered separately via the resend_ebooks tool.
 *
 * Run: pnpm medusa exec ./src/scripts/send-confirmation-louwes.ts
 */

const ORDER_ID = "order_01KYTWQ7F2W1XE28Z8RJ5W7BDB"
const LABEL = "Louwes"
const PAYMENT_METHOD = "Bankoverschrijving"
