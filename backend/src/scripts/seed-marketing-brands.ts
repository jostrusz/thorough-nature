...
export default async function seedMarketingBrands({ container }: ExecArgs) {
  ...
  const brands = [
    ...
    },
    {
      ...
      project_id: "lass-los",
      storefront_domain: "jetztloslassen.de",
      marketing_from_email: "news@news.jetztloslassen.de",
      marketing_from_name: "Lass los, was dich kaputt macht",
      marketing_reply_to: "buch@jetztloslassen.de",
    ...
    },
    {
      ...
      storefront_domain: "pusttocotenici.cz",
      marketing_from_email: "news@news.pusttocotenici.cz",
      marketing_from_name: "Pusť to, co tě ničí",
      marketing_reply_to: "podpora@pusttocotenici.cz",
