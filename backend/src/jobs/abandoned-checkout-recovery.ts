...
const KB_STEPS: StepConfig[] = [
  {
    ...
    subject: (name) => name ? `${name}, vaše kniha je zabalená` : `Vaše kniha je zabalená`,
    preview: "Kočičí bible je zabalená. Čeká jen na potvrzení.",
    delayMs: THIRTY_MINUTES_MS,
    delayFrom: (_meta, abandonedAt) => abandonedAt,
  },
  {
    ...
    subject: (name) => name ? `${name}, dvanáct let jsem si to zapisoval` : `Dvanáct let jsem si to zapisoval`,
  ...
  },
  {
    ...
    subject: (name) => name ? `${name}, zítra ten košík uvolním` : `Zítra ten košík uvolním`,
    preview: "Zbývá 24 hodin, pak musím košík uvolnit.",
    delayMs: TWENTY_FOUR_HOURS_MS,
    delayFrom: (meta) => new Date(meta.recovery_email_step2_at),
  },
]
...
const MB_STEPS: StepConfig[] = [
  {
    ...
    subject: (name) => name ? `Szia ${name}, a könyved félbemaradt a kosaradban 📦` : `A könyved félbemaradt a kosaradban 📦`,
    preview: "A Macskabiblia be van csomagolva. Csak te maradtál félúton.",
    delayMs: THIRTY_MINUTES_MS,
    delayFrom: (_meta, abandonedAt) => abandonedAt,
  },
  {
    ...
    subject: (name) => name ? `${name}, elmondom, miért írtam meg ezt a könyvet` : `Elmondom, miért írtam meg ezt a könyvet`,
  ...
  },
  {
    ...
    subject: (name) => name ? `${name}, holnap felszabadul a kosarad` : `Holnap felszabadul a kosarad`,
