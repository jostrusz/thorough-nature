...
const PROJECT_CONFIGS: Record<string, ProjectEmailConfig> = {
  ...
  suelta: {
    ...
    fromName: 'Suelta lo que te destruye',
    fromEmail: 'Suelta lo que te destruye <hola@sueltaloquetedestruye.es>',
    project: 'suelta',
    locale: 'es',
  ...
  'engedd-el': {
    ...
    fromEmail: 'Joris de Vries - Engedd el, ami tönkretesz <info@engeddelkonyv.hu>',
    project: 'engedd-el',
    locale: 'hu',
    smsDispatchTemplate: 'Engedd el, ami tonkretesz: Csomagod uton van. Kovetes: {url} info@engeddelkonyv.hu',
  },
  // Also match without hyphen
  engeddel: {
    replyTo: 'info@engeddelkonyv.hu',
