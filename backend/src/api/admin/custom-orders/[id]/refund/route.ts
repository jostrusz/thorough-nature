      ...
      metadata: {
        ...
        payment_activity_log: [
          ...existingActivityLog,
          {
            ...
            amount,
            currency,
            transaction_id: paymentData.molliePaymentId || paymentData.stripePaymentIntentId || paymentData.paypalOrderId || paymentData.klarnaOrderId || paymentData.comgateTransId || paymentData.airwallexPaymentIntentId || paymentData.id || "",
            refund_id: refundResult.refundId,
