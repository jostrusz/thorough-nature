...
const EBOOK_FILES_BY_PROJECT: Record<string, Array<{ key: string; title: string; description: string; size: string }>> = {
  ...
  'slipp-taket': [
    { key: "e-books/Losningen pa overtenking.pdf", title: "Løsningen på overtenking", description: "E-bok (PDF)", size: "1.4 MB" },
    { key: "e-books/Kjaerlighet uten sensur.pdf", title: "Kjærlighet uten sensur", description: "E-bok (PDF)", size: "17.1 MB" },
  ],
  'odpusc-ksiazka': [
    { key: "e-books/Koniec nadmiernym mysleniem.pdf", title: "Koniec nadmiernym myśleniem", description: "E-book (PDF)", size: "1.2 MB" },
  ...
  'zivot-zaslugy': [
    { key: "e-books/Posun-jednu-vec-zmen-vsechno.pdf", title: "Posuň jednu věc, změň všechno", description: "E-book (PDF)", size: "8.3 MB" },
    { key: "e-books/Ne-vse-ma-mit-svoje-misto.pdf", title: "Ne vše má mít svoje místo", description: "E-book (PDF)", size: "6.7 MB" },
  ],
  'zycie-zaslugy': [
