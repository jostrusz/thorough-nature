...
const BUNDLE_PRICING: Record<string, Record<number, number>> = {
  ...
  // Pusť to, co tě ničí — hlavní produkt CZ (odpust-knizka)
  "pust-to-co-te-nici": {
    1: 749,   // 749 Kč incl. DPH
    2: 1199,  // 1199 Kč incl. DPH (save 299 Kč)
    3: 1599,  // 1599 Kč incl. DPH (save 648 Kč)
    4: 1999,  // 1999 Kč incl. DPH (save 997 Kč)
  },
  // Pusti to, čo ťa ničí — SK edition (EUR). Single book 32 € (original 35 €).
  "pusti-to": {
    1: 32,    // 32,00 € incl. DPH (original 35 €)
    2: 52,    // 52,00 € incl. DPH (save 12 €)
    3: 70,    // 70,00 € incl. DPH (save 26 €)
    4: 88,    // 88,00 € incl. DPH (save 40 €)
  },
  ...
  // Larga o que te destrói — edição PT (larga), EUR
  "larga-o-que-te-destroi": {
    1: 36,    // 36 € IVA incl. (6% taxa reduzida)
    2: 61,    // 61 € (poupas 11 €)
    3: 82,    // 82 € (poupas 26 €)
    4: 102,   // 102 € (poupas 42 €)
  },
...
const BUNDLE_SKU_PATTERNS: RegExp[] = [
  ...
  /^LARGA-(\d+)$/,   // larga PT: LARGA-1, LARGA-2, LARGA-3, LARGA-4
]
