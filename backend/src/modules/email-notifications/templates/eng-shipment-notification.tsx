...
export const ENG_SHIPMENT_NOTIFICATION = 'eng-shipment-notification'

export interface EngShipmentNotificationTemplateProps {
  order: any
  shippingAddress: any
...
export const isEngShipmentNotificationData = (data: any): data is EngShipmentNotificationTemplateProps =>
...
export const EngShipmentNotificationTemplate: React.FC<EngShipmentNotificationTemplateProps> & {
  PreviewProps: any
} = ({
  order,
  shippingAddress,
      ...
      <Section>
            ...
            <div style={{
              ...
              {trackingCompany && (
                <Text style={{
                  ...
                  Futárszolgálat: <strong style={{ color: '#2D1B3D' }}>{trackingCompany}</strong>
                </Text>
              )}
              {trackingNumber && (
                <Text style={{
        ...
        <div style={{ padding: `20px ${pad} 0 ${pad}` }}>
          <Text style={{
            ...
            {isPickup ? 'Átvételi pont' : 'Szállítási cím'}
          </Text>
          <div style={{
            backgroundColor: '#FAF5F8',
            borderRadius: '10px',
          ...
          <table role="presentation" width="100%" cellPadding={0} cellSpacing={0} style={{ borderCollapse: 'collapse' as const, marginBottom: '12px' }}>
            <tbody>
              <tr>
                ...
                <td style={{ fontFamily: font, fontSize: '13px', color: '#5A3D6B', lineHeight: '1.5', paddingLeft: '8px' }}>
                  <strong style={{ color: '#2D1B3D' }}>Úton van</strong>
                  <br />
                  {isPickup
                    ? 'A küldemény az átvételi pontod felé tart.'
                    : 'A futárszolgálat a megadott címre viszi a küldeményt.'
                  }
                </td>
              </tr>
            </tbody>
            ...
            <tbody>
              <tr>
                ...
                <td style={{ fontFamily: font, fontSize: '13px', color: '#5A3D6B', lineHeight: '1.5', paddingLeft: '8px' }}>
                  ...
                  <br />
                  {isPickup
                    ? '2–3 munkanapon belül átveheted a küldeményt az átvételi ponton!'
        ...
        <div style={{ padding: `24px ${pad} 0 ${pad}` }}>
          <div style={{
            ...
            <Text style={{
              ...
              Kérdésed van a küldeményről? Írj nekünk a
              <br />
        ...
        <div style={{
          ...
          <Text style={{
            ...
            {billingEntity?.registration_id && (
              <>
                <br />
                Cégjegyzékszám: {billingEntity.registration_id}
              </>
            )}
            {!billingEntity && (
              <>
...
EngShipmentNotificationTemplate.PreviewProps = {
  order: {
    id: 'test-order-id',
    display_id: '812',
...
export default EngShipmentNotificationTemplate
