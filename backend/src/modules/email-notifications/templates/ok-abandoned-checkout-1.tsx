...
export const OK_ABANDONED_CHECKOUT_1 = 'ok-abandoned-checkout-1'

export interface OkAbandonedCheckout1Props {
  firstName: string
  checkoutUrl: string
  productName: string
  productPrice: string
...
export const isOkAbandonedCheckout1Data = (data: any): data is OkAbandonedCheckout1Props =>
...
export const OkAbandonedCheckout1Template: React.FC<OkAbandonedCheckout1Props> & {
  PreviewProps: OkAbandonedCheckout1Props
} = ({
  firstName,
  checkoutUrl,
  productName,
      ...
      <Section>
        ...
        <div style={{ padding: `28px ${pad} 0` }}>
          ...
          <Text style={{
            ...
            Czy wiesz, że większość z nas nosi w sobie rzeczy, które nas niszczą — stare wzorce, bolesne relacje, myśli, które nas więzią — nawet nie zdając sobie z tego sprawy? Jedna jedyna zmiana perspektywy może być różnicą między dalszą walką a prawdziwym uwolnieniem się.
          </Text>
          <Text style={{
            fontFamily: font,
            fontSize: '15px',
            ...
            Właśnie to znajdziesz w tej książce. Żadnych pustych obietnic. Żadnych skomplikowanych metod. Tylko jasne, sprawdzone kroki, które możesz zacząć stosować już dziś.
          </Text>
        </div>
...
OkAbandonedCheckout1Template.PreviewProps = {
  firstName: 'Anna',
  ...
  productImage: '',
  preview: 'Twoja książka jest zapakowana i czeka na Ciebie!',
} as OkAbandonedCheckout1Props

export default OkAbandonedCheckout1Template
