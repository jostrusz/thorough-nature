...
export const ENG_ABANDONED_CHECKOUT_3 = 'eng-abandoned-checkout-3'

export interface EngAbandonedCheckout3Props {
  firstName: string
  checkoutUrl: string
  productName: string
  productPrice: string
...
export const isEngAbandonedCheckout3Data = (data: any): data is EngAbandonedCheckout3Props =>
...
export const EngAbandonedCheckout3Template: React.FC<EngAbandonedCheckout3Props> & {
  PreviewProps: EngAbandonedCheckout3Props
} = ({
  firstName,
  checkoutUrl,
  productName,
      ...
      <Section>
        ...
        <div style={{ padding: `20px ${pad} 0` }}>
          ...
          <Text style={{
            ...
            Hány éjszakát fekszel még át álmatlanul a gondolatok miatt, amelyeket nem lehet leállítani? Hányszor mondod még azt, hogy &bdquo;majd később&rdquo; arra a változásra, amelyre legbelül szükséged van?
          </Text>
          <Text style={{
            fontFamily: font,
            fontSize: '15px',
            ...
            A fájdalom, amibe kapaszkodsz, már nem ad neked semmit. Ideje elengedni azt, ami tönkretesz.
          </Text>
        </div>
        ...
        <div style={{
          ...
          <Text style={{
            ...
            Ez az utolsó emlékeztető a rendeléseddel kapcsolatban. Több értesítést már nem küldünk.
          </Text>
        </div>
      </Section>
    </Base>
...
EngAbandonedCheckout3Template.PreviewProps = {
  firstName: 'Eszter',
  ...
  productImage: '',
  preview: 'Még 24 óra — utána fel kell szabadítanom a kosaradat.',
} as EngAbandonedCheckout3Props

export default EngAbandonedCheckout3Template
