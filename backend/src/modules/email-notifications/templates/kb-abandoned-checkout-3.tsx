...
export const KB_ABANDONED_CHECKOUT_3 = 'kb-abandoned-checkout-3'

export interface KbAbandonedCheckout3Props {
  firstName: string
  checkoutUrl: string
  productName: string
  productPrice: string
...
export const isKbAbandonedCheckout3Data = (data: any): data is KbAbandonedCheckout3Props =>
...
export const KbAbandonedCheckout3Template: React.FC<KbAbandonedCheckout3Props> & {
  PreviewProps: KbAbandonedCheckout3Props
} = ({
  firstName,
  checkoutUrl,
  productName,
...
KbAbandonedCheckout3Template.PreviewProps = {
  firstName: 'Petra',
  ...
  productImage: '',
  preview: 'Zbývá 24 hodin — pak musím tvůj košík uvolnit.',
} as KbAbandonedCheckout3Props

export default KbAbandonedCheckout3Template
