...
export const MB_ABANDONED_CHECKOUT_2 = 'mb-abandoned-checkout-2'

export interface MbAbandonedCheckout2Props {
  firstName: string
  checkoutUrl: string
  productName: string
  productPrice: string
...
export const isMbAbandonedCheckout2Data = (data: any): data is MbAbandonedCheckout2Props =>
...
export const MbAbandonedCheckout2Template: React.FC<MbAbandonedCheckout2Props> & {
  PreviewProps: MbAbandonedCheckout2Props
} = ({
  firstName,
  checkoutUrl,
  productName,
    ...
    <Base preview={preview}>
      <Section>
        ...
        <div style={{ padding: `0 ${pad}` }}>
          ...
          <ReviewCard
            text="A macskánk három évig pisilt a kanapé mögé. HÁROM ÉVIG. Két héttel azután, hogy a könyv szerint csináltuk, nyugalom lett. Nem értem, miért nem mondta ezt el senki hamarabb."
            author="Kovács Eszter, Budapest"
          />
          <ReviewCard
            text="Kipróbáltunk sprayeket, feromonokat, fórumos tanácsokat. Semmi. Ez a könyv elmagyarázta, MIÉRT csinálja ezt Mia — és hirtelen értelmet nyert az egész. Végre átalusszuk az éjszakát."
            author="Tóth Gábor, Debrecen"
          />
          <ReviewCard
            text="Már az első héten érezhető volt a különbség. A lépések annyira konkrétak, hogy rögtön tudod, mit csinálj másképp. A kandúrunk mintha kicserélték volna."
            author="Varga Anita, Szeged"
          />
        </div>
...
MbAbandonedCheckout2Template.PreviewProps = {
  firstName: 'Anna',
