...
export const OD_ABANDONED_CHECKOUT_1 = 'od-abandoned-checkout-1'

export interface OdAbandonedCheckout1Props {
  firstName: string
  checkoutUrl: string
  productName: string
  productPrice: string
...
export const isOdAbandonedCheckout1Data = (data: any): data is OdAbandonedCheckout1Props =>
...
export const OdAbandonedCheckout1Template: React.FC<OdAbandonedCheckout1Props> & {
  PreviewProps: OdAbandonedCheckout1Props
} = ({
  firstName,
  checkoutUrl,
  productName,
      ...
      <Section>
        ...
        <div style={{ padding: `28px ${pad} 0` }}>
          ...
          <Text style={{
            ...
            Věděla jsi, že většina lidí neuvízne proto, že by nebyli dost silní? Uvíznou, protože nevědí, <em>co</em> mají pustit — a jak. Přemítání, pocity viny, vztek, strach z opuštění — pořád se to vrací.
          </Text>
          <Text style={{
            fontFamily: font,
            fontSize: '15px',
            ...
            V této knize se naučíš, jak zastavit lavinu myšlenek, zklidnit emoce a najít vnitřní klid. Vše stojí na neurovědě, filozofii a psychologii chování — včetně kompletního pracovního sešitu plného praktických cvičení. Žádné vágní rady. Žádné spirituální sliby.
          </Text>
        </div>
...
OdAbandonedCheckout1Template.PreviewProps = {
  firstName: 'Petra',
  ...
  productImage: '',
  preview: 'Tvoje kniha je zabalená a čeká jen na tebe!',
} as OdAbandonedCheckout1Props

export default OdAbandonedCheckout1Template
