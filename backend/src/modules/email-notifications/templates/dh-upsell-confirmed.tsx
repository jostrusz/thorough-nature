...
export interface DhUpsellConfirmedTemplateProps {
  order: any
  shippingAddress: any
  addedItems?: any[]
  billingEntity?: any
...
export const isDhUpsellConfirmedData = (data: any): data is DhUpsellConfirmedTemplateProps =>
...
export const DhUpsellConfirmedTemplate: React.FC<DhUpsellConfirmedTemplateProps> & {
  PreviewProps: any
} = ({
  order,
  shippingAddress,
  addedItems,
  billingEntity,
  preview = 'Je bestelling is bijgewerkt!',
}) => {
      ...
      <Section>
        ...
        <div style={{ padding: `24px ${pad} 0`, textAlign: 'center' as const }}>
          <div style={{
            ...
            <Text style={{
              ...
              &#10003; Artikel toegevoegd aan je bestelling
            </Text>
          </div>
        </div>
        ...
        <div style={{ padding: `24px ${pad} 0` }}>
          ...
          <Text style={{
            ...
            Geweldige keuze! We hebben het extra artikel aan je bestelling toegevoegd. Beide boeken worden samen in &eacute;&eacute;n pakket verstuurd.
          </Text>
        </div>
          ...
          <div style={{
            ...
            <table role="presentation" width="100%" cellPadding={0} cellSpacing={0} style={{ borderCollapse: 'collapse' as const }}>
              <tbody>
                {codFee > 0 && (
                  <tr>
                    <td style={{ fontFamily: font, fontSize: '13px', color: colors.textBody, padding: '3px 0' }}>Rembours</td>
                    <td align="right" style={{ fontFamily: font, fontSize: '13px', color: colors.textBody, padding: '3px 0' }}>{formatPrice(codFee, currency)}</td>
                  </tr>
                )}
                {shippingFee > 0 && (
                  <tr>
                    <td style={{ fontFamily: font, fontSize: '13px', color: colors.textBody, padding: '3px 0' }}>Verzending</td>
                ...
                <tr>
                  <td style={{ fontFamily: font, fontSize: '18px', fontWeight: 800, color: colors.textDark, padding: '8px 0 0' }}>Nieuw totaal</td>
        ...
        <div style={{ padding: `24px ${pad} 0` }}>
          <div style={{
            ...
            <Text style={{
              ...
              &#128230; &nbsp;<strong>Beide boeken worden samen verstuurd</strong>
            </Text>
            <Text style={{
              fontFamily: font,
              fontSize: '12px',
              ...
              Verwachte levertijd: 4–7 werkdagen
            </Text>
          </div>
        </div>
...
DhUpsellConfirmedTemplate.PreviewProps = {
  order: {
    id: 'test-order-id',
    display_id: '54',
    metadata: { custom_order_number: 'NL2026-54' },
    ...
    summary: {
      raw_current_order_total: { value: 64.85 },
    },
  },
  shippingAddress: {
    first_name: 'Jan',
...
export default DhUpsellConfirmedTemplate
