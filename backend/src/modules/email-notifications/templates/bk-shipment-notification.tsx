...
export const BK_SHIPMENT_NOTIFICATION = 'bk-shipment-notification'

export interface BkShipmentNotificationTemplateProps {
  order: any
  shippingAddress: any
...
export const isBkShipmentNotificationData = (data: any): data is BkShipmentNotificationTemplateProps =>
...
function formatCountry(code: string): string {
  const map: Record<string, string> = {
    pl: 'Polska', cz: 'Czechy', sk: 'Słowacja', de: 'Niemcy',
    at: 'Austria', nl: 'Holandia', be: 'Belgia', hu: 'Węgry',
  }
  return map[(code || '').toLowerCase()] || (code || '').toUpperCase()
}

export const BkShipmentNotificationTemplate: React.FC<BkShipmentNotificationTemplateProps> & {
  PreviewProps: any
} = ({
  order,
  shippingAddress,
      ...
      <Section>
        ...
        <div style={{ padding: `24px ${pad} 0` }}>
          ...
          <Text style={{
            ...
            {isPickup
              ? 'Świetna wiadomość! Twoje zamówienie zostało zapakowane i wysłane do punktu odbioru. Gdy tylko będzie gotowe do odbioru, dostaniesz kolejne powiadomienie.'
            ...
            <div style={{
              ...
              {trackingCompany && (
                <Text style={{
                  ...
                  Przewoźnik: <strong style={{ color: colors.textDark }}>{trackingCompany}</strong>
                </Text>
              )}
              {trackingNumber && (
                <Text style={{
                  ...
                  Numer przesyłki: <strong style={{ color: colors.textDark }}>{trackingNumber}</strong>
                </Text>
              )}
              {trackingUrl && (
                <Link
        ...
        <div style={{ padding: `12px ${pad} 0` }}>
          <div style={{
            ...
            <Text style={{
              ...
              {isPickup
                ? <><strong>&#128205; Dostawa do punktu odbioru</strong></>
                : <><strong>&#128666; Przewidywana dostawa: 2–5 dni roboczych</strong></>
              }
            </Text>
            <Text style={{
              fontFamily: font,
              ...
              {isPickup ? 'Przesyłkę odbierzesz w wybranym punkcie odbioru.' : 'Książki wysyłamy z naszego centralnego magazynu.'}
            </Text>
          </div>
        </div>
            ...
            <tbody>
              <tr>
                ...
                <td style={{ fontFamily: font, fontSize: '14px', color: colors.textBody, lineHeight: '1.6', paddingLeft: '6px' }}>
                  ...
                  <br />
                  <span style={{ fontSize: '13px', color: colors.textMuted }}>Twoje zamówienie zostało zapakowane i wysłane z naszego magazynu.</span>
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <table role="presentation" width="100%" cellPadding={0} cellSpacing={0} style={{ borderCollapse: 'collapse' as const, marginBottom: '16px' }}>
            <tbody>
              <tr>
                ...
                <td style={{ fontFamily: font, fontSize: '14px', color: colors.textBody, lineHeight: '1.6', paddingLeft: '6px' }}>
                  <strong style={{ color: colors.textDark }}>W drodze</strong>
                  <br />
                  <span style={{ fontSize: '13px', color: colors.textMuted }}>{isPickup ? 'Przesyłka zmierza do Twojego punktu odbioru.' : 'Przewoźnik dostarcza przesyłkę na Twój adres.'}</span>
                </td>
              </tr>
            </tbody>
          </table>
            ...
            <tbody>
              <tr>
                ...
                <td style={{ fontFamily: font, fontSize: '14px', color: colors.textBody, lineHeight: '1.6', paddingLeft: '6px' }}>
                  ...
                  <br />
                  <span style={{ fontSize: '13px', color: colors.textMuted }}>{isPickup ? 'Przesyłkę odbierzesz w punkcie odbioru.' : 'W ciągu 2–5 dni roboczych książka będzie u Ciebie w domu.'}</span>
                </td>
              </tr>
            </tbody>
          </table>
...
BkShipmentNotificationTemplate.PreviewProps = {
  order: {
    id: 'test-order-id',
    display_id: '812',
    metadata: { custom_order_number: 'PL2026-812' },
  ...
  trackingUrl: 'https://tracking.packeta.com/pl/Z10009876543',
  trackingCompany: 'Packeta',
  pickupPoint: null,
} as any

export default BkShipmentNotificationTemplate
