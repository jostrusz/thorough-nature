import { Html, Body, Container, Preview, Head, Link, Font } from '@react-email/components'
import * as React from 'react'

interface ZzBaseProps {
  preview?: string
  children: React.ReactNode
}

/**
 * Email base styled to match the zycie-zaslugy storefront (najpierw-ja.pl).
 *
 ...
 */
export const ZzBase: React.FC<ZzBaseProps> = ({ preview, children }) => {
  return (
    <Html>
      <Head>
        <Font
