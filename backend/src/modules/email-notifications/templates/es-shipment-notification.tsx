...
export const ES_SHIPMENT_NOTIFICATION = 'es-shipment-notification'

export interface EsShipmentNotificationTemplateProps {
  order: any
  shippingAddress: any
...
export const isEsShipmentNotificationData = (data: any): data is EsShipmentNotificationTemplateProps =>
...
export const EsShipmentNotificationTemplate: React.FC<EsShipmentNotificationTemplateProps> & {
  PreviewProps: any
} = ({
  order,
  shippingAddress,
  ...
  billingEntity,
  pickupPoint,
  preview = '¡Tu pedido está en camino!',
}) => {
      ...
      <Section>
        ...
        <div style={{ padding: `28px ${pad} 0 ${pad}` }}>
          ...
          <Text style={{
            ...
            {isPickup
              ? '¡Buenas noticias! Tu pedido ya está empaquetado y va camino de tu punto de recogida. Abajo encontrarás los detalles del envío.'
              : '¡Buenas noticias! Tu pedido ya está empaquetado y de camino hacia ti. Abajo encontrarás los detalles del envío.'
            }
          </Text>
        </div>
            ...
            <div style={{
              ...
              {trackingNumber && (
                <Text style={{
                  ...
                  Número de seguimiento: <strong style={{ color: '#2D1B3D' }}>{trackingNumber}</strong>
                </Text>
              )}
              {trackingUrl && (
                <Link
        ...
        <div style={{ padding: `12px ${pad} 0 ${pad}` }}>
          <div style={{
            ...
            <Text style={{
              ...
              {isPickup
                ? 'En cuanto el paquete esté listo para recoger, el punto de recogida te avisará.'
                : 'Enviamos los libros desde nuestro almacén central en la República Checa.'
              }
            </Text>
          </div>
        </div>
            ...
            <tbody>
              <tr>
                ...
                <td style={{ fontFamily: font, fontSize: '13px', color: '#5A3D6B', lineHeight: '1.5', paddingLeft: '8px' }}>
                  ...
                  <br />
                  Tu pedido ha sido empaquetado y enviado desde nuestro almacén.
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <table role="presentation" width="100%" cellPadding={0} cellSpacing={0} style={{ borderCollapse: 'collapse' as const, marginBottom: '12px' }}>
            <tbody>
              <tr>
                ...
                <td style={{ fontFamily: font, fontSize: '13px', color: '#5A3D6B', lineHeight: '1.5', paddingLeft: '8px' }}>
                  <strong style={{ color: '#2D1B3D' }}>En camino</strong>
                  <br />
                  {isPickup
                    ? 'El paquete va camino de tu punto de recogida.'
                    : 'El transportista lleva el paquete a la dirección indicada.'
                  }
                </td>
              </tr>
            </tbody>
            ...
            <tbody>
              <tr>
                ...
                <td style={{ fontFamily: font, fontSize: '13px', color: '#5A3D6B', lineHeight: '1.5', paddingLeft: '8px' }}>
                  ...
                  <br />
                  {isPickup
                    ? '¡En 2–3 días laborables podrás recoger tu paquete en el punto de recogida!'
        ...
        <div style={{ padding: `24px ${pad} 0 ${pad}` }}>
          <div style={{
            ...
            <Text style={{
              ...
              ¿Alguna duda sobre tu envío? Escríbenos a
              <br />
...
EsShipmentNotificationTemplate.PreviewProps = {
  order: {
    id: 'test-order-id',
    display_id: '812',
...
export default EsShipmentNotificationTemplate
